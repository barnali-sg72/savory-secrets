...
export default function FavoriteSection() {
    ...
    const favtitles = [ "Grilled Sesame Chicken", 
    ...
    return (
        <div className="favorite p-3">
            <h2 className="text-start mt-3 ms-3">Most Popular Recipes</h2>
            <div className="d-flex fav-list justify-content-between mt-3 p-2">
                {favorites.map(rec => (
